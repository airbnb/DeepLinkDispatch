      ...
      .generatesSources(
        ...
        JavaFileObjects.forSourceString("/SOURCE_OUTPUT.com.example.SampleModuleRegistry",
          "package com.example;\n"
            ...
            + ".com\\u0003\\u0002\\b\\u0000\\u0000\\u0000\\u0000\\u0000\\u0000deepLink\\u0001\\u000"
            + "2\\u0007\\u0000\\u0000\\u00005ÿÿexample\\u0002\\u0002\\u000b\\u0000\\u0000\\u0000!ÿÿ"
            + "example.com\\u0003\\u0002\\u0007\\u0000\\u0000\\u0000\\u0000\\u0000\\u0001another\\u"
            + "0003\\u0002\\b\\u0000\\u0000\\u0000\\u0000\\u0000\\u0002deepLink\\u0001\\u0002\\u000"
            + "4\\u0000\\u0000\\u00005ÿÿhttp\\u0002\\u0002\\u000b\\u0000\\u0000\\u0000!ÿÿexample.co"
            + "m\\u0003\\u0002\\u0007\\u0000\\u0000\\u0000\\u0000\\u0000\\u0003another\\u0003\\u000"
            + "2\\b\\u0000\\u0000\\u0000\\u0000\\u0000\\u0004deepLink\\u0001\\u0002\\u0005\\u0000\\"
            + "u0000\\u00005ÿÿhttps\\u0002\\u0002\\u000b\\u0000\\u0000\\u0000!ÿÿexample.com\\u0003"
            + "\\u0002\\u0007\\u0000\\u0000\\u0000\\u0000\\u0000\\u0005another\\u0003\\u0002\\b\\u0"
            + "000\\u0000\\u0000\\u0000\\u0000\\u0006deepLink\";}\n"
            + "}"
        ));
      ...
      .generatesSources(
        ...
        JavaFileObjects.forSourceString("/SOURCE_OUTPUT.com.example."
          ...
          "package com.example;\n"
            ...
            + "  public SampleModuleRegistry() {\n"
            + "    super(Collections.unmodifiableList(Arrays.<DeepLinkEntry>asList(\n"
            + "      new DeepLinkEntry(\"airbnb://host/path1/path3?q={q}\", DeepLinkEntry.Type.METH"
            + "OD, SampleActivity.class, \"intentFromTwoPathWithQuery\"),\n"
            + "      new DeepLinkEntry(\"airbnb://host/path1/path2\", DeepLinkEntry.Type.METHOD, Sa"
            + "mpleActivity.class, \"intentFromTwoPath\"),\n"
            + "      new DeepLinkEntry(\"airbnb://host/{var1}/{var2}\", DeepLinkEntry.Type.METHOD, "
            + "SampleActivity.class, \"intentFromTwoPathWithTwoParams\"),\n"
            + "      new DeepLinkEntry(\"airbnb://host/path\", DeepLinkEntry.Type.METHOD, SampleAct"
            + "ivity.class, \"intentFromOnePath\"),\n"
            + "      new DeepLinkEntry(\"airbnb://host/{var}\", DeepLinkEntry.Type.METHOD, SampleAc"
            + "tivity.class, \"intentFromOnePathWithOneParam\")\n"
            + "    )), Utils.readMatchIndexFromStrings( new String[] {matchIndex0(), }),\n"
            + "    new HashSet<String>(Arrays.<String>asList()));\n"
            + "  }\n"
            + "\n"
            + "  private static String matchIndex0() {\n"
            + "    return \"\\u0000\\u0002\\u0001\\u0000\\u0000\\u0000\\u007fÿÿr\\u0001\\u0002\\u00"
            + "06\\u0000\\u0000\\u0000pÿÿairbnb\\u0002\\u0002\\u0004\\u0000\\u0000\\u0000cÿÿhost\\u"
            + "0003\\u0002\\u0005\\u0000\\u0000\\u0000\\u001cÿÿpath1\\u0003\\u0002\\u0005\\u0000\\u"
            + "0000\\u0000\\u0000\\u0000\\u0000path3\\u0003\\u0002\\u0005\\u0000\\u0000\\u0000\\u00"
            + "00\\u0000\\u0001path2\\u0003\\u0004\\u0006\\u0000\\u0000\\u0000\\u000fÿÿ{var1}\\u000"
            + "3\\u0004\\u0006\\u0000\\u0000\\u0000\\u0000\\u0000\\u0002{var2}\\u0003\\u0002\\u0004"
            + "\\u0000\\u0000\\u0000\\u0000\\u0000\\u0003path\\u0003\\u0004\\u0005\\u0000\\u0000\\"
            + "u0000\\u0000\\u0000\\u0004{var}\";}\n"
            + "}"));
