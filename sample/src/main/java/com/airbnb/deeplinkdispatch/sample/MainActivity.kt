...
class MainActivity : AppCompatActivity() {
    object InnerClass {
        ...
        @JvmStatic
        fun intentForDeepLinkMethod(context: Context): Intent = Intent(context, MainActivity::class.java).setAction(ACTION_DEEP_LINK_INNER)
    }
...
object MainActivityDeeplinks {
    ...
    private fun getTaskStackBuilder(
        context: Context,
        action: String,
    ): TaskStackBuilder {
    ...
    @JvmStatic
    fun nullDeepLinkMethiodResult(context: Context?): DeepLinkMethodResult? = null

    @DeepLink("dld://host/taskStackBuilder/null")
    @JvmStatic
    fun nullTaskStackBuilder(context: Context?): TaskStackBuilder? = null

    @DeepLink("dld://host/intent/null")
    @JvmStatic
    fun nullIntent(context: Context?): Intent? = null
    ...
    @JvmStatic
    fun sampleDuplicatedUrlWithDifferentPlaceholderName1(context: Context?): Intent? = null
    ...
    @JvmStatic
    fun sampleDuplicatedUrlWithDifferentPlaceholderName2(context: Context?): Intent? = null
    ...
    @JvmStatic
    fun lessConcreteMatch(
        context: Context?,
        bundle: Bundle?,
    ): Intent = handleConcreteMatchLink(context, bundle)

    @DeepLink("placeholder://host/{param1}/somePathTwoAlt/somePathThreeAlt")
    @JvmStatic
    fun lessConcreteMatchAlt(
        context: Context,
        bundle: Bundle,
    ): Intent = handleConcreteMatchLink(context, bundle)
    ...
    @JvmStatic
    fun lessConcreteMatchMany(
        context: Context,
        bundle: Bundle,
    ): Intent = handleConcreteMatchLink(context, bundle)

    private fun handleConcreteMatchLink(
        context: Context?,
        bundle: Bundle?,
    ): Intent {
