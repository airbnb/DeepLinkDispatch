        ...
        .generatesSources(
            ...
            JavaFileObjects.forSourceString("/SOURCE_OUTPUT.com.example.SampleModuleLoader",
                "package com.example;\n"
                    ...
                    + ".CLASS, SampleActivity.class, null, null)));\n"
                    + "\n"
                    + "  @Override"
        ...
        .generatesSources(
            ...
            JavaFileObjects.forSourceString("/SOURCE_OUTPUT.com.example.SampleModuleLoader",
                "package com.example;\n"
                    ...
                    + "    new DeepLinkEntry(\"airbnb://example.com/deepLink\", DeepLinkEntry.Type"
                    + ".CLASS, SampleActivity.class, null, null),\n"
                    + "    new DeepLinkEntry(\"example.com/deepLink\", DeepLinkEntry.Type"
                    + ".CLASS, SampleActivity.class, null, new String[]{\"example://\"}),\n"
                    + "    new DeepLinkEntry(\"example.com/another\", DeepLinkEntry.Type"
                    + ".CLASS, SampleActivity.class, null, new String[]{\"example://\"}),\n"
                    + "    new DeepLinkEntry(\"example.com/deepLink\", DeepLinkEntry.Type"
                    + ".CLASS, SampleActivity.class, null, new String[]{\"http://\", \"https://\"})"
                    + ",\n"
                    + "    new DeepLinkEntry(\"example.com/another\", DeepLinkEntry.Type"
                    + ".CLASS, SampleActivity.class, null, new String[]{\"http://\", \"https://\"})"
                    + "\n"
