...
class DeepLinkProcessorIncrementalTest : BaseDeepLinkProcessorTest() {
    ...
    private val sampleActivityWithStandardAndCustomDeepLink =
        Source.JavaSource(
    ...
    private val sampleActivityWithInnerClassDeeplinkJava =
        Source.JavaSource(
            "com.example.SampleActivity",
            """
                 package com.example;
    ...
    private val secondSampleActivityWithInnerClassDeeplinkJava =
        Source.JavaSource(
    ...
    private val sampleActivityWithInnerClassDeeplinkKotlin =
        Source.KotlinSource(
            "SampleActivity.kt",
            """
                 package com.example
    ...
    private val sampleWrongClassTypeAnnotated =
        Source.KotlinSource(
    ...
    private val sampleActivityWithOnlyCustomDeepLink =
        Source.JavaSource(
            "com.example.SampleActivity",
            """
    ...
    private val sampleActivityWithOnlyCustomPlaceholderDeepLink =
        Source.JavaSource(
            "com.example.SampleActivity",
            """
                 package com.example;import com.airbnb.deeplinkdispatch.DeepLink;
