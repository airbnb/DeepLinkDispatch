...
import com.airbnb.deeplinkdispatch.sample.handler.TestKotlinDeepLinkHandlerDeepLinkArgsMissingPathParamExtraQueryParm
...
class DeepLinkHandlerTest {
    ...
    fun testKotlinHandlerPartialArgumentClass() {
        ...
        val expectedDeepLinkParams =
            TestKotlinDeepLinkHandlerDeepLinkArgsMissingPathParamExtraQueryParm(1, null, 17, null)
        verify(exactly = 1) {
